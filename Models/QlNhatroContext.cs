...
public partial class QlNhatroContext : DbContext
{
    ...
    {
        // DbContext connection is configured centrally in Program.cs via AddDbContext.
        // Keep this empty to avoid hard-coded environment-specific connection strings.
    }
