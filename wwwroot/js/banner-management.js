class BannerManagement {
    ...
    showEditModal(bannerId) {
        ...
        // Show image update note
        const imageNote = document.getElementById('imageUpdateNote');
        if (imageNote) imageNote.style.display = 'block';
    ...
    clearForm() {
        ...
        // Hide image update note
        const imageNote = document.getElementById('imageUpdateNote');
        if (imageNote) imageNote.style.display = 'none';
    }
    ...
    async saveBanner() {
        ...
        try {
            ...
            const contentElement = document.getElementById('bannerContent');
            ...
            const redirectUrl = redirectUrlElement ? (redirectUrlElement.value || '').trim() : '';
            const isActive = isActiveElement ? (isActiveElement.value || 'true') : 'true';
    ...
    validateForm() {
        ...
        // Validate status
        const isActiveElement = document.getElementById('isActive');
        const isActive = isActiveElement ? isActiveElement.value : '';
        if (!isActive) {
